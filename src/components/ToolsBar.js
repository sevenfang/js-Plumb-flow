...
import withDragDropContext from './DraggableNodeFlow/withDragDropContext';
...
@connect(mapStateToProps, mapDispatchToProps)
 class ToolsBar extends Component {
    ...
    render() {
        ...
        console.log(propertyDataToJs)
        // console.log("`````----- propertyData -----", this.props,propertyDataToJs)
...
export default withDragDropContext(ToolsBar);