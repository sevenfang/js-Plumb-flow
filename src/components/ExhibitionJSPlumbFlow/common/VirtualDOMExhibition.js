...
export default class VirtualDOMHandleExhibition {
    ...
    constructor(dataSource, eventObj) {
        ...
        // console.log(JSON.parse(this.bpmnInfo.designJson))
    }
    ...
    init(styleNewObj){
        ...
        const allNodeList = this.nodeData.map((info) => {
            ...
            // newStyleObjCopy = newStyleObj;
            return this.getRenderSortFlow(info, newStyleObj, extraInfo);
        });
        return allNodeList;
        // return {allNodeList:allNodeList,newStyleObjCopy:newStyleObjCopy,extraInfo:extraInfo} ;
    }
