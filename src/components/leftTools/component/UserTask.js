...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
        ...
        return {
            ...
            assignee:"",// 指派人传递的信息，实际上这个字段才是真正传给后台的数据
            assigneeArray:[],//指派人的展示信息，实际上是用来展示给用户看的
            assigneeArrayOther:[{type:null,value:[]},{type:true,value:[]},{type:false,value:[]}],//单会签指派人的展示信息，实际上是用来展示给用户看的
            completionCondition:'',//多会签完成条件表达式
            completionConditionType:'',//多会签完成条件表达式类型。
            completionConditionArray:[{type:true,value:['activiti','']},{type:false,value:['activiti','']}],
            isSequential:null,//选择会签的类型
            assigneeGroup:"",//指派组
            assigneeGroupArrayOther:[{type:null,value:[]},{type:true,value:[]},{type:false,value:[]}],//指派组的展示信息，实际上是用来展示给用户看的
            assigneeGroupArray:[],
        };
    }
};
