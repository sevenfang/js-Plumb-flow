...
class NodeFlow extends Component {
    ...
    render() {
        console.log('NodeFlow///this.props',this.props);
        const {nodeList, propertyData, error, bankFormList, data4, handleSetDataSource, handleSetReRender, handleSetProperty, getBankFormList, mode } = this.props;
        let propertyDataToJs = propertyData.toJS();
        let nodeListJs = nodeList.toJS();
        console.log('NodeFlow///this.props',nodeListJs);
