...
import RegularExpressConfig from "../../../indexRugularExpressConfig";
// 引入高阶组件函数
...
class ConnectLine extends Component {
  ...
  changeLanguage(){
    ...
    render() {
        ...
        console.log(propertyData.renderType)
                    ...
                    :
                        <div className="item-container">
                            ...
                            >
                                ...
                                {/*/>*/}
                                 <RegularExpressConfig
                                    onLanguageSelected={this.handleChangeRulesLanguage}
                                    onAceChange={this.onChangeEdit}
                                    mode={this.props.mode?this.props.mode:''}
                                    personlizeParams={{rulesLanguage:this.props.propertyData.rulesLanguage,ruleExpresstion:this.props.propertyData.rules}}
                                    requestUrl={'/bank/condition/get'}
                                    params={{type:'workflow_gateway'}}
